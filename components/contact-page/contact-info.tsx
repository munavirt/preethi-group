      ...
      <div className="site-container">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8">
          ...
          <div className="flex flex-col">
            ...
            <Reveal delay={0.1}>
              <a
                ...
                className="text-lg md:text-xl font-sans text-muted-foreground hover:text-brand-red transition-colors duration-300"
              >
          ...
          <div className="flex flex-col">
            ...
            <Reveal delay={0.2}>
              <span className="text-lg md:text-xl font-sans text-muted-foreground">
